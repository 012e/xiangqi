...
export const getHealthQueryOptions = <TData = Awaited<ReturnType<typeof health>>, TError = unknown>(options?: {
    ...
    } as UseQueryOptions<Awaited<ReturnType<typeof health>>, TError, TData> & {
...
export function useHealth<TData = Awaited<ReturnType<typeof health>>, TError = unknown>(
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof health>>, TError, TData>> & Pick<
            DefinedInitialDataOptions<
...
export const getHealthAuthQueryOptions = <TData = Awaited<ReturnType<typeof healthAuth>>, TError = unknown>(options?: {
                                                                                                                query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof healthAuth>>, TError, TData>>,
                                                                                                                request?: SecondParameter<typeof customInstance>
                                                                                                            }
) => {
    ...
    return {
        queryKey,
        queryFn, ...queryOptions
    } as UseQueryOptions<Awaited<ReturnType<typeof healthAuth>>, TError, TData> & {
        queryKey: DataTag<QueryKey, TData, TError>
    }
}
...
export function useHealthAuth<TData = Awaited<ReturnType<typeof healthAuth>>, TError = unknown>(
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof healthAuth>>, TError, TData>> & Pick<
            DefinedInitialDataOptions<
