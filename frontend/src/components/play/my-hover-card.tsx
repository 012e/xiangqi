      ...
      <HoverCard>
        <div className="flex items-center">
          ...
          <HoverCardTrigger>
            <div className="flex flex-col p-2 ">
              ...
              <span className="text-md text-muted-foreground flex items-center tracking-tight">
        ...
        <HoverCardContent className="w-auto" asChild>
          <div className="flex flex-col gap-2 p-3">
            <div className="flex">
              <img src={props.image} className="rounded-md size-25 flex items-center justify-center" alt="Avatar" />
